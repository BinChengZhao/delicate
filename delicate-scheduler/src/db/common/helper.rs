...
generate_operation_log_fn!(("task"=>""), ("task_log"=>""), ("executor_processor"=>""), ("executor_group"=>""), ("executor_processor_bind"=>""), ("user"=>""), ("user_role"=>""), ("user_permission"=>"") );
