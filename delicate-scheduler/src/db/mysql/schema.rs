...
table! {
    ...
    task_log (id) {
        ...
        /// (Automatically generated by Diesel.)
        created_time -> Timestamp,
        /// The `deleted_time` column of the `task_log` table.
        ///
        /// Its SQL type is `Nullable<Timestamp>`.
        ///
        /// (Automatically generated by Diesel.)
...
table! {
    /// Representation of the `user_base` table.
    ///
    /// (Automatically generated by Diesel.)
    user_base (user_id) {
        /// The `user_id` column of the `user_base` table.
        ///
        /// Its SQL type is `Bigint`.
        ///
        /// (Automatically generated by Diesel.)
        user_id -> Bigint,
        /// The `user_name` column of the `user_base` table.
        ///
        /// Its SQL type is `Varchar`.
        ///
        /// (Automatically generated by Diesel.)
        user_name -> Varchar,
        /// The `nick_name` column of the `user_base` table.
        ///
        /// Its SQL type is `Varchar`.
        ///
        /// (Automatically generated by Diesel.)
        nick_name -> Varchar,
        /// The `mobile` column of the `user_base` table.
        ///
        /// Its SQL type is `Varchar`.
        ///
        /// (Automatically generated by Diesel.)
        mobile -> Varchar,
        /// The `email` column of the `user_base` table.
        ///
        /// Its SQL type is `Varchar`.
        ///
        /// (Automatically generated by Diesel.)
        email -> Varchar,
        /// The `face` column of the `user_base` table.
        ///
        /// Its SQL type is `Varchar`.
        ///
        /// (Automatically generated by Diesel.)
        face -> Varchar,
        /// The `status` column of the `user_base` table.
        ///
        /// Its SQL type is `Tinyint`.
        ///
        /// (Automatically generated by Diesel.)
        status -> Tinyint,
        /// The `created_time` column of the `user_base` table.
        ///
        /// Its SQL type is `Timestamp`.
        ///
        /// (Automatically generated by Diesel.)
        created_time -> Timestamp,
        /// The `updated_time` column of the `user_base` table.
        ///
        /// Its SQL type is `Timestamp`.
        ///
        /// (Automatically generated by Diesel.)
